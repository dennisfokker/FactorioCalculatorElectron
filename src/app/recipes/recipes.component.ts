...
export class RecipesComponent implements OnInit
{
    ...
    ngOnInit()
    {
        ...
        const recipe = new Recipe('Iron storage box', 1, undefined,
            [
                new Ingredient(ingredientResult.item, 1, undefined,
        ...
        const recipe2 = new Recipe('Electronic circuit', 0.5, undefined,
            [
                new Ingredient(
                    new Item('Iron plate', 'iron-plate.png', undefined), 1, undefined,
                ...
                new Ingredient(
                    new Item('Copper cable', 'copper-cable.png', undefined), 3, undefined,
                    new Recipe('Copper cable', 0.5, undefined,
                        [
                            new Ingredient(
                                new Item('Copper plate', 'copper-plate.png', undefined), 2, undefined,
        ...
        this.ingredients = [new Ingredient(result.item, 1, undefined, recipe), new Ingredient(result.item, 1, undefined, recipe)];
        this.sharedIngredients = [new Ingredient(result.item, 1, undefined, recipe), new Ingredient(result2.item, 2, undefined, recipe2)];
    }
